    ...
    <main>
      <section className="bg-slate-50">
        <Container className="grid min-h-[calc(100vh-5rem)] items-center gap-12 py-14 lg:grid-cols-[1fr_0.92fr] lg:py-20">
          ...
          <div className="relative min-h-[520px] overflow-hidden rounded-lg bg-[url('https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=1200&auto=format&fit=crop')] bg-cover bg-center shadow-2xl shadow-slate-900/20">
            <div className="absolute bottom-5 left-5 right-5 rounded-lg bg-white/95 p-5 shadow-xl backdrop-blur">
              <p className="text-sm font-semibold text-emerald-700">Market snapshot</p>
              <div className="mt-4 grid grid-cols-3 gap-3 text-center">
                <div>
                  <p className="text-2xl font-semibold text-slate-950">2.4k</p>
                  <p className="mt-1 text-xs text-slate-500">Active listings</p>
                </div>
                <div>
                  <p className="text-2xl font-semibold text-slate-950">18</p>
                  <p className="mt-1 text-xs text-slate-500">Cities</p>
                </div>
                <div>
                  <p className="text-2xl font-semibold text-slate-950">24h</p>
                  <p className="mt-1 text-xs text-slate-500">Fresh updates</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-emerald-800 py-20 text-white">
        <Container className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <ButtonLink className="bg-white text-emerald-900 hover:bg-emerald-50" href="/register">
              Register
            </ButtonLink>
            <ButtonLink
