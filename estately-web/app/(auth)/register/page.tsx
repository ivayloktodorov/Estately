  ...
  return (
    <main className="bg-slate-50">
      <section className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[0.9fr_1fr] lg:px-8">
        <div className="hidden min-h-[560px] rounded-lg bg-[url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200&auto=format&fit=crop')] bg-cover bg-center shadow-2xl shadow-slate-900/15 lg:block" />
