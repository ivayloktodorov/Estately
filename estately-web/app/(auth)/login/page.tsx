    ...
    <main className="bg-cream-50">
      <section className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8">
        <div className="mx-auto w-full max-w-md rounded-lg border border-stone-200 bg-white p-6 shadow-estate sm:p-8">
          ...
          <h1 className="mt-3 text-3xl font-semibold text-charcoal-950">Welcome back</h1>
        ...
        <div className="hidden min-h-[560px] rounded-lg bg-[url('https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1200&auto=format&fit=crop')] bg-cover bg-center shadow-2xl shadow-charcoal-950/15 lg:block" />
      </section>
    </main>
  );
}
