            ...
            <div className="min-w-0">
              ...
              <div className="mt-3 flex min-w-0 items-center gap-2">
                {otherParticipant.avatarUrl ? (
                  <img alt="" className="h-9 w-9 rounded-full object-cover" src={otherParticipant.avatarUrl} />
                ) : (
              ...
              <article className={`flex items-end gap-2 ${isOwn ? 'justify-end' : 'justify-start'}`} key={message.id}>
                {!isOwn ? (
                  message.senderAvatarUrl ? (
                    <img alt="" className="h-8 w-8 shrink-0 rounded-full object-cover" src={message.senderAvatarUrl} />
                  ) : (
