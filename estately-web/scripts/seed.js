...
import { users, cities, properties, propertyImages, favorites, propertyMessages } from '../src/db/schema/index.js';
...
const sampleUsers = [
  ...
  { email: 'david@gmail.com', password: 'pass123', fullName: 'David Smith', role: 'user' },
  { email: 'user1@gmail.com', password: 'pass123', fullName: 'User One', role: 'user' },
  { email: 'user2@gmail.com', password: 'pass123', fullName: 'User Two', role: 'user' },
  { email: 'user3@gmail.com', password: 'pass123', fullName: 'User Three', role: 'user' },
  { email: 'user4@gmail.com', password: 'pass123', fullName: 'User Four', role: 'user' },
  { email: 'user5@gmail.com', password: 'pass123', fullName: 'User Five', role: 'user' },
  { email: 'user6@gmail.com', password: 'pass123', fullName: 'User Six', role: 'user' },
  { email: 'user7@gmail.com', password: 'pass123', fullName: 'User Seven', role: 'user' },
  { email: 'user8@gmail.com', password: 'pass123', fullName: 'User Eight', role: 'user' },
  { email: 'user9@gmail.com', password: 'pass123', fullName: 'User Nine', role: 'user' },
  { email: 'user10@gmail.com', password: 'pass123', fullName: 'User Ten', role: 'user' },
];
...
async function seed() {
  try {
    ...
    for (const prop of insertedPropertiesResult) {
      const propertyImageCount = Math.floor(Math.random() * 3) + 2; // 2-4 images per property
    ...
    for (let i = 2; i <= 5; i++) { // Users 2-5
      const numFavorites = Math.floor(Math.random() * 5) + 2; // 2-6 favorites per user
      const propertyIds = [];
    ...
    if (favoritesToInsert.length > 0) {
      ...
      console.log('✓ No favorites created (avoiding conflicts)\n');
    }

    // Insert property messages
    console.log('💬 Seeding property messages...');
    const messagesToInsert = [];
    for (const prop of insertedPropertiesResult.slice(0, 10)) { // Messages for first 10 properties
      const numMessages = Math.floor(Math.random() * 3) + 1; // 1-3 messages per property
      for (let i = 0; i < numMessages; i++) {
        const userId = Math.floor(Math.random() * (sampleUsers.length - 1)) + 2; // Random user (not admin)
