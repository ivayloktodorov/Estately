...
export const INVALID_IMAGE_VALUES = new Set(['', 'null', 'undefined', '/images/property-placeholder.jpg']);
...
export function getPropertyPlaceholderImage(propertyType: string | null | undefined): string {
  ...
  return normalizedType
    ? PROPERTY_PLACEHOLDER_BY_TYPE[normalizedType] ?? PROPERTY_IMAGE_PLACEHOLDER_URL
